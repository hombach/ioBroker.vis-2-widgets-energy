import { _ as v } from "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.js-CXPcvUgs.js";
import { o as T } from "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare__react__loadShare__.js-C1tKYn4A.js";
import { E as S } from "./index-Hxpn76vy.js";
import { g as x, h } from "./Utils-CEFQvMQb.js";
import { _ as I } from "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare___mf_0_iobroker_mf_1_adapter_mf_2_react_mf_2_v5__loadShare__.js-CRiN9_kO.js";
...
import "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare___mf_0_mui_mf_1_material__loadShare__.js-3MHKpXP4.js";
...
import "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare___mf_0_mui_mf_1_icons_mf_2_material__loadShare__.js-bDbg5xfN.js";
...
class y extends w {
  ...
  getTimeWidget(t) {
    var _a;
    const a = (_a = window.document.getElementById(t || this.state.rxData.timeWidget)) == null ? void 0 : _a.querySelector(".time-selector");
    return (a == null ? void 0 : a._addEventHandler) ? a : null;
  }
  getHistory(t, e) {
  ...
  registerTimeSelector() {
    !this.timeSelectorRegistered && this.state.rxData.timeWidget && this.props.context.views[this.props.view].widgets[this.state.rxData.timeWidget] && (this.timeSelectorRegisterInterval || (this.timeSelectorRegisterInterval = setInterval(() => {
      if (!this.timeSelectorRegistered && this.state.rxData.timeWidget) {
        ...
        (t == null ? void 0 : t._addEventHandler) && (t._addEventHandler(this.onTimeFromWidgetChanged), this.timeSelectorRegistered = this.state.rxData.timeWidget);
      }
    ...
    if (t === "unmount") {
      if (this.timeSelectorRegistered) {
        ...
        if (a) {
          ...
          r && ((_a = r._removeEventHandler) == null ? void 0 : _a.call(r, this.onTimeFromWidgetChanged), this.timeSelectorRegistered = false);
        }
      }
      this.registerTimeSelector();
    } else t === "update" && e && (this.timeStart !== e.start || this.timeInterval !== e.interval) && (this.timeStart = e.start, this.timeInterval = e.interval, setTimeout(() => this.readCharts(), 0));
  };
  onStateUpdated() {
  ...
  getOption() {
    ...
    return { backgroundColor: "transparent", tooltip: {}, legend: { top: 5, left: "center", data: t.map((i) => ({ name: i.name, textStyle: r })) }, toolbox: { feature: { magicType: { type: ["stack"] }, dataView: {} } }, grid: { containLabel: true, left: 10, top: 40, right: 10, bottom: 10 }, yAxis: { name: e }, xAxis: { type: "category", data: (_b = (_a = t == null ? void 0 : t[0]) == null ? void 0 : _a.values) == null ? void 0 : _b.map((i) => h(i.ts).format(a[this.getTimeInterval()])) }, series: t.map((i) => {
      var _a2;
      return { type: "bar", name: i.name, itemStyle: { color: i.color }, data: (_a2 = i.values) == null ? void 0 : _a2.map((c) => c.val * i.factor), stack: this.state.rxData.stacked === false ? void 0 : "one" };
    }) };
  }
  getTimeStart() {
    let t;
  ...
  renderWidgetBody(t) {
    ...
    const a = v("div", { ref: this.refCardContent, style: C.cardContent, children: e && v(S, { option: this.getOption(), theme: this.props.context.themeType === "dark" ? "dark" : "", style: { height: `${e}px`, width: "100%" }, opts: { renderer: "svg" } }) });
