import { _ as r } from "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.js-CXPcvUgs.js";
import { o as h } from "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare__react__loadShare__.js-C1tKYn4A.js";
import { q as c } from "./_virtual_mf___mfe_internal__vis2energyWidgets__mf_owner__1__loadShare___mf_0_mui_mf_1_material__loadShare__.js-3MHKpXP4.js";
import { E as m } from "./index-Hxpn76vy.js";
...
class l extends o {
  ...
  static getWidgetInfo() {
    return { id: "tplEnergy2ConsumptionComparison", visSet: "vis-2-widgets-energy", visWidgetLabel: "consumption_comparison", visName: "Consumption comparison", visAttrs: [{ name: "common", fields: [{ name: "noCard", label: "without_card", type: "checkbox" }, { name: "type", label: "type", type: "select", options: [{ value: "bar", label: "bar" }, { value: "pie", label: "pie" }], default: "bar" }, { name: "noAnimation", label: "no_animation", type: "checkbox" }, { name: "animationDuration", label: "animation_duration", type: "number", default: 1e3, hidden: (a) => !!a.noAnimation }, { name: "innerRadius", label: "inner_radius", type: "slider", min: 0, max: 80, hidden: 'data.type !== "pie"' }, { name: "innerTitle", label: "inner_title", type: "text", hidden: 'data.type !== "pie"' }, { name: "inner_oid", label: "inner_oid", type: "id", hidden: 'data.type !== "pie"', onChange: async (a, n, e, i) => {
      ...
      const t = n[a.name] ? await i.getObject(n[a.name]) : null;
      (t == null ? void 0 : t.common) && (n[`color${a.index}`] = t.common.color ?? null, n[`name${a.index}`] = o.getText(t.common.name), e(n));
  ...
  getBarOption() {
    ...
    for (let e = 1; e <= this.state.rxData.devicesCount; e++) {
      ...
      this.state.rxData[`factor${e}`] && this.state.rxData[`factor${e}`] !== 1 && (i *= parseFloat(this.state.rxData[`factor${e}`])), i = Math.round(i * 100) / 100, a.push({ name: this.state.rxData[`name${e}`] || "", value: i, color: this.state.rxData[`color${e}`] || void 0 });
    }
    a.reverse();
...
`), rich: { text: { fontSize: 10 }, value: { fontSize: 20 } }, left: "center", top: "center", textStyle: { color: this.props.context.themeType === "dark" ? "#c7c7c7" : "#3d3d3d" } };
  ...
  renderWidgetBody(a) {
    ...
    const e = this.state.rxData.type === "pie" ? this.getPieOption() : this.getBarOption(), i = r(c, { ref: this.refCardContent, sx: p.cardContent, children: n && r(m, { option: e, theme: this.props.context.themeType === "dark" ? "dark" : "", className: "vis-2-widgets-energy-chart", opts: { renderer: "svg" }, style: { height: n } }) });
