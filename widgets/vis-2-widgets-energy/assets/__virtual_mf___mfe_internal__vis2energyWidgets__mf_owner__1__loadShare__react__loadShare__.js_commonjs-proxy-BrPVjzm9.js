...
function y(e, t, r) {
  this.props = e, this.context = t, this.refs = N, this.updater = r || D;
}
...
var w = C.prototype = new $();
w.constructor = C;
L(w, y.prototype);
w.isPureReactComponent = true;
var k = Array.isArray, A = Object.prototype.hasOwnProperty, j = { current: null }, V = { key: true, ref: true, __self: true, __source: true };
function M(e, t, r) {
  var n, o = {}, f = null, a = null;
  if (t != null) for (n in t.ref !== void 0 && (a = t.ref), t.key !== void 0 && (f = "" + t.key), t) A.call(t, n) && !V.hasOwnProperty(n) && (o[n] = t[n]);
...
function h(e, t, r, n, o) {
  ...
  if (a) return a = e, o = o(a), e = n === "" ? "." + v(a, 0) : n, k(o) ? (r = "", e != null && (r = e.replace(I, "$&/") + "/"), h(o, t, r, "", function(_) {
    return _;
  })) : o != null && (T(o) && (o = re(o, r + (!o.key || a && a.key === o.key ? "" : ("" + o.key).replace(I, "$&/") + "/") + e)), t.push(o)), 1;
  if (a = 0, n = n === "" ? "." : n + ":", k(e)) for (var l = 0; l < e.length; l++) {
    f = e[l];
    var c = n + v(f, l);
    a += h(f, t, r, c, o);
  }
...
u.cloneElement = function(e, t, r) {
  ...
  var n = L({}, e.props), o = e.key, f = e.ref, a = e._owner;
  if (t != null) {
    if (t.ref !== void 0 && (f = t.ref, a = j.current), t.key !== void 0 && (o = "" + t.key), e.type && e.type.defaultProps) var l = e.type.defaultProps;
    for (c in t) A.call(t, c) && !V.hasOwnProperty(c) && (n[c] = t[c] === void 0 && l !== void 0 ? l[c] : t[c]);
  }
...
x.exports = u;
var U = x.exports;
const se = H(U), g = W({ __proto__: null, default: se }, [U]), s = g, fe = s.Children, ae = s.Component, ce = s.Fragment, le = s.Profiler, ie = s.PureComponent, _e = s.StrictMode, pe = s.Suspense, ye = s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, de = s.act, me = s.cloneElement, he = s.createContext, be = s.createElement, Se = s.createFactory, Ee = s.createRef, ve = s.forwardRef, ge = s.isValidElement, Oe = s.lazy, Re = s.memo, Ce = s.startTransition, we = s.unstable_act, je = s.useCallback, Te = s.useContext, Pe = s.useDebugValue, ke = s.useDeferredValue, Ie = s.useEffect, xe = s.useId, De = s.useImperativeHandle, Le = s.useInsertionEffect, Ne = s.useLayoutEffect, $e = s.useMemo, Ae = s.useReducer, Ve = s.useRef, Me = s.useState, Fe = s.useSyncExternalStore, Ue = s.useTransition, ze = s.version, We = Reflect.get(g, "default") ?? g, He = Object.freeze(Object.defineProperty({ __proto__: null, Children: fe, Component: ae, Fragment: ce, Profiler: le, PureComponent: ie, StrictMode: _e, Suspense: pe, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: ye, act: de, cloneElement: me, createContext: he, createElement: be, createFactory: Se, createRef: Ee, default: We, forwardRef: ve, isValidElement: ge, lazy: Oe, memo: Re, startTransition: Ce, unstable_act: we, useCallback: je, useContext: Te, useDebugValue: Pe, useDeferredValue: ke, useEffect: Ie, useId: xe, useImperativeHandle: De, useInsertionEffect: Le, useLayoutEffect: Ne, useMemo: $e, useReducer: Ae, useRef: Ve, useState: Me, useSyncExternalStore: Fe, useTransition: Ue, version: ze }, Symbol.toStringTag, { value: "Module" })), E = "__mf_module_cache__";
...
}, O = /* @__PURE__ */ Symbol.for("module-federation.shared-cache-listeners"), qe = (e) => {
  let t = e[O];
...
}, R = /* @__PURE__ */ Symbol.for("module-federation.shared-cache-owners"), Ge = (e) => {
  let t = e[R];
  return t === void 0 && (t = /* @__PURE__ */ Object.create(null), Object.defineProperty(e, R, { value: t, enumerable: false, configurable: false, writable: false })), t;
}, Ye = (e, t, r, n) => {
  var _a2;
  e[t.canonical] = r;
  const o = t.aliases || [];
  for (const a of o) Object.defineProperty(e, a, { value: r, enumerable: true, configurable: true, writable: true });
  e[R], Ge(e)[t.canonical] = n;
  const f = (_a2 = e[O]) == null ? void 0 : _a2[t.canonical];
...
let S = Ke(p.share, { canonical: "default:react", aliases: ["react"] });
S === void 0 && (S = Je(He), Ye(p.share, { canonical: "default:react", aliases: ["react"] }, S, "vis2energyWidgets"));
let Qe;
const z = (e) => {
  ...
  e.Children, e.Component, e.Fragment, e.Profiler, e.PureComponent, e.StrictMode, e.Suspense, e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, e.act, e.cloneElement, e.createContext, e.createElement, e.createFactory, e.createRef, e.forwardRef, e.isValidElement, e.lazy, e.memo, e.startTransition, e.unstable_act, e.useCallback, e.useContext, e.useDebugValue, e.useDeferredValue, e.useEffect, e.useId, e.useImperativeHandle, e.useInsertionEffect, e.useLayoutEffect, e.useMemo, e.useReducer, e.useRef, e.useState, e.useSyncExternalStore, e.useTransition, e.version, Qe = (() => {
    ...
    for (let n = 0; n < 5; n++) {
      const o = r == null ? void 0 : r.default;
      if (!o || typeof o != "object") return o ?? r;
      r = o;
    }
    return r;
  })();
};
Be(p.share, { canonical: "default:react" }, z);
z(S);
export {
  Qe as _,
  g as a,
