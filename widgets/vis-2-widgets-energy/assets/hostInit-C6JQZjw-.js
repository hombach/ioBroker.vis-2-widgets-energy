import { _ as b } from "./vite-preload-helper-PPVm8Dsz.js";
let d, g;
let __tla = (async () => {
  var _a, _b;
  ...
  g = async function() {
    return d || (d = (async () => {
      ...
      const s = (r, e, t, o) => {
        ...
        const { usedShared: r } = await import("./_virtual_mf-localSharedImportMap___mfe_internal__vis2energyWidgets__mf_owner__1-haJ_8P-h.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        });
        return {
