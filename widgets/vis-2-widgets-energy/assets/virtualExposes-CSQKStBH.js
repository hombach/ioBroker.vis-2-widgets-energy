...
let __tla = (async () => {
  ...
  f = {
    "./Consumption": async () => {
      ...
      const e = await s(() => r(() => import("./Consumption-CPin1N2X.js"), [], import.meta.url)), t = e && e.__mf_remote_dependency_pending;
    ...
    "./ConsumptionComparison": async () => {
      ...
      const e = await s(() => r(() => import("./ConsumptionComparison-awrfUYkf.js"), [], import.meta.url)), t = e && e.__mf_remote_dependency_pending;
      t && typeof t.then == "function" && await t;
      const n = {};
      return Object.assign(n, e), Object.defineProperty(n, "__esModule", {
        value: true,
    ...
    "./Distribution": async () => {
      ...
      const e = await s(() => r(() => import("./Distribution-eJcgohOM.js"), [], import.meta.url)), t = e && e.__mf_remote_dependency_pending;
      t && typeof t.then == "function" && await t;
      const n = {};
      return Object.assign(n, e), Object.defineProperty(n, "__esModule", {
        value: true,
    ...
    "./translations": async () => {
      ...
      const e = await s(() => r(() => import("./translations-DTaCV53w.js"), [], import.meta.url)), t = e && e.__mf_remote_dependency_pending;
      t && typeof t.then == "function" && await t;
      const n = {};
      return Object.assign(n, e), Object.defineProperty(n, "__esModule", {
        value: true,
