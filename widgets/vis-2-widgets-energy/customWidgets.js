import { _ as ve } from "./assets/vite-preload-helper-PPVm8Dsz.js";
import { h as Ke, i as Be, __tla as __tla_0 } from "./assets/index-COpJWj9b.js";
let nr, rr;
let __tla = Promise.all([
  ...
  const d = globalThis[J];
  for (const s of Object.keys(d.share)) if (s.startsWith("default:")) {
    const a = s.slice(8);
    d.share[a] === void 0 && (d.share[a] = d.share[s]);
  } else if (!s.includes(":")) {
    const a = "default:" + s;
    d.share[a] === void 0 && (d.share[a] = d.share[s]);
  }
  ...
  const ge = /* @__PURE__ */ Symbol("mf.originalSharedProvider"), Ue = {
    ...
    const f = {};
    for (const [_, w] of Object.entries(s)) f[_] = Object.assign({}, w, {
      [ge]: w
    });
    return f;
  }, re = (s, a) => {
    if (!a) return;
    const f = Object.entries(s || {}), _ = f.find(([, g]) => g === a);
    if (_) return {
      version: _[0],
      provider: a,
      registered: true
    ...
    const w = f.filter(([, g]) => g === a || !!(a.from && (g == null ? void 0 : g.from) === a.from));
    ...
    var _a2;
    if (!s || !f) return;
    const w = Array.isArray(f.scope) ? f.scope : [
      f.scope || "default"
    ], g = qe(s, _), E = {};
    ...
    var _a2;
    const w = (S) => x(S, f), g = Object.fromEntries(Object.entries(s || {}).filter(([, S]) => !w(S)));
    (f == null ? void 0 : f.version) && ((_a2 = f.shareConfig) == null ? void 0 : _a2.import) !== false && (g[f.version] || (g[f.version] = f));
    const E = te(g, a, f, _);
    return w(E) ? void 0 : E;
  }, x = (s, a) => s === a || !!((a == null ? void 0 : a.from) && (s == null ? void 0 : s.from) === a.from), Je = (s, a, f, _, w, g, E, S, T) => {
    var _a2, _b2, _c;
    if (!S) return;
    ...
    return D && s.some((M) => {
      var _a3, _b3;
      return M !== a && ((_a3 = M == null ? void 0 : M.options) == null ? void 0 : _a3.name) === (E == null ? void 0 : E.from) && ((_b3 = M == null ? void 0 : M.shareScopeMap) == null ? void 0 : _b3[_]) === f;
    }) ? D : void 0;
  }, Qe = (s, a, f, _, w, g, E, S, T) => {
    const V = g.registered ? Je(s, a, f, _, w, g.version, g.provider, S) : void 0, A = V || E;
  ...
  async function Xe() {
    return H || (H = oe(() => ve(() => import("./assets/_virtual_mf-localSharedImportMap___mfe_internal__vis2energyWidgets__mf_owner__1-haJ_8P-h.js").then(async (m) => {
      await m.__tla;
      return m;
  ...
  async function Ye() {
    return U || (U = oe(() => ve(() => import("./assets/virtualExposes-CV1ODRC9.js").then(async (m) => {
      await m.__tla;
      return m;
  ...
  rr = async function(s = {}, a = []) {
    ...
    const f = (r, e, n, t) => {
      ...
      const o = [
        ...new Set(n)
      ].sort(), i = A(r), c = i[_a3 = e.canonical] || (i[_a3] = []), u = c.find((m) => m.providedExports.length === o.length && m.providedExports.every((j, h) => j === o[h]));
    ...
    const Ce = (r, e, n, t) => {
      ...
      try {
        ...
        throw m.release(false), P;
      }
      const h = j == null ? void 0 : j.factory;
      if (h === void 0) {
        m.release(false);
        return;
      }
      const l = Ee(n), y = m.provider.treeShaking || m.provider, O = m.provider.lib === h || y.lib === h;
      if (!c && O) {
        const P = l.findIndex((k) => k.provider === m.provider);
        P !== -1 && l.splice(P, 1);
      }
      !c && !l.some((P) => P.provider === i) && l.push({
        provider: i,
        version: t,
        from: u,
        registered: false,
      ...
      const b = !c && j.selectedProvider === m.provider && O ? i : j.selectedProvider;
      if (b && !l.some((P) => P.provider === b)) {
        const P = W.get(b), k = typeof b.version == "string" && b.version ? b.version : t;
        l.push({
          provider: b,
          version: k,
          from: P ? P.from : b.from,
          registered: (n == null ? void 0 : n[k]) === b,
          loadedFactory: h
        });
      }
      const v = l.find((P) => P.provider === b) ?? Ie(l, h);
      ...
      if (!t && e.canLiveRebind !== false) try {
        ...
        const u = f(r, t, e.version, e.scope);
        if (_(d.share, u) !== void 0) return;
        const m = s[r], j = m == null ? void 0 : m[c];
        if (i.registered && !x(j, o)) return;
        let h, l = o.lib;
        if (!l && o.loading && (l = await o.loading), !l && o.loaded && typeof o.get == "function" && (l = await o.get()), !l) return;
        const y = typeof l == "function" ? l() : l, O = await Promise.resolve(y), b = i.registered ? j : o;
        h = {
          provider: b,
          selection: {
            provider: b,
        ...
        if (p === void 0 || _(d.share, u) !== void 0 || R.registered && (m == null ? void 0 : m[R.version]) !== v) return;
        T(d.share, u, ae(p), R.from), $.add(v);
      } catch (o) {
      ...
      var _a3, _b3;
      try {
        const i = f(r, (_a3 = e.shareConfig) == null ? void 0 : _a3.singleton, e.version, e.scope), c = _(d.share, i), u = S(d.share, i), m = q(n, r, e, "version-first"), j = m || te(n, r, e, "version-first") || e, h = re(n, j);
        if (!h) return;
        const l = x(j, e), { version: y } = h;
        if (!((_b3 = e.shareConfig) == null ? void 0 : _b3.singleton) && y !== e.version) return;
        const O = t == null ? void 0 : t[y], b = Qe(Q, be, s, "default", r, h, m, O, "version-first");
        if (!b && !l) return;
        const { provider: v, scopeRootProvider: R } = b || {
          provider: j,
          scopeRootProvider: void 0
        };
        if (e.canLiveRebind === false || c !== void 0 && u !== I) return;
        const p = s[r], N = p == null ? void 0 : p[y];
        if (h.registered && !R && !x(N, v)) return;
        const L = await ce(r, e.shareConfig, p, y, N, v, h.registered && !l), P = L == null ? void 0 : L.provider, k = L == null ? void 0 : L.selection;
        if (!k || x(P, e) || o && (o.version !== k.version || !x({
          from: k.from
        }, o.provider)) || $.has(P)) return;
        const me = L == null ? void 0 : L.resolved;
        if (me === void 0) return;
        const Ne = _(d.share, i), De = S(d.share, i);
        if (Ne !== void 0 && De !== I || k.registered && (p == null ? void 0 : p[k.version]) !== P) return;
        o || ee.set(r, {
          version: k.version,
          provider: {
            from: k.from
    ...
    for (const [r, e] of Object.entries(C)) {
      ...
      const n = f(r, (_c = e.shareConfig) == null ? void 0 : _c.singleton, e.version, e.scope);
      if (_(d.share, n) !== void 0) continue;
      const t = f(r, true, e.version, e.scope), o = _(d.share, t);
      o !== void 0 && T(d.share, n, o, S(d.share, t));
    }
    const F = [
      "react",
      "react/jsx-runtime",
    ...
    var le = async (r) => {
      var _a3, _b3;
      for (const e of r) {
        const n = C[e], t = f(e, (_a3 = n.shareConfig) == null ? void 0 : _a3.singleton, n.version, n.scope);
        if (((_b3 = n.shareConfig) == null ? void 0 : _b3.import) === false || n.treeShaking || _(d.share, t) !== void 0) continue;
        const o = f(e, true, n.version, n.scope), i = _(d.share, o);
        if (i !== void 0) {
          T(d.share, t, i, S(d.share, o));
          continue;
        }
        const c = await n.get(), u = typeof c == "function" ? c() : c, m = await Promise.resolve(u), h = ((y) => {
          let O = y;
          for (let b = 0; b < 5; b++) {
    ...
    const ue = (r) => {
      ...
      const n = f(r, (_b3 = e.shareConfig) == null ? void 0 : _b3.singleton, e.version, e.scope);
      return e.treeShaking ? M(d.share, n, I) === void 0 && _(d.share, n) === void 0 : _(d.share, n) === void 0;
    }, Me = (r) => {
      var _a3, _b3;
      const e = C[r], n = f(r, (_a3 = e.shareConfig) == null ? void 0 : _a3.singleton, e.version, e.scope);
      return (e.treeShaking ? M(d.share, n, I) ?? _(d.share, n) : _(d.share, n)) !== void 0 ? false : e.treeShaking || ((_b3 = e.shareConfig) == null ? void 0 : _b3.import) === false ? true : typeof q != "function" ? false : !!q(z[r], r, e, "version-first");
    ...
    try {
      ...
      if (r) for (const [, n] of Object.entries(r)) for (const t of He) {
        ...
        if (o) for (const [i, c] of Object.entries(o)) {
          const u = C == null ? void 0 : C[i], m = z[i], j = ee.get(i);
          if (!u || !m || !j || u.treeShaking) continue;
          const h = e[i] || (e[i] = /* @__PURE__ */ Object.create(null));
          for (const [l, y] of Object.entries(c)) {
            if (!y.lib || j.version !== l || !x(y, j.provider)) continue;
            const O = m[l];
            (y === O || (O == null ? void 0 : O.from) && y.from === O.from) && (y === u || u.from && y.from === u.from || h[l] === void 0 && (h[l] = y));
          }
        }
      }
    ...
    const Ve = async () => {
      ...
      var _a3, _b3;
      const n = f(r, (_a3 = e.shareConfig) == null ? void 0 : _a3.singleton, e.version, e.scope), t = e.treeShaking ? M(d.share, n, I) : _(d.share, n);
      ...
      const o = (R) => {
        ...
        for (let N = 0; N < 5; N++) {
          ...
          const P = Object.keys(p).filter((k) => k !== "default").map((k) => p[k]);
          if (P.length > 0 && P.some((k) => k !== void 0)) break;
          p = L;
        }
        return p;
      }, i = s == null ? void 0 : s[r], c = te(i, r, e, "version-first") || e, u = re(i, c);
      if (!u) return;
      const { version: m } = u, j = i == null ? void 0 : i[m], h = await ce(r, e.shareConfig, i, m, j, c, u.registered && !x(c, e)), l = h == null ? void 0 : h.selection, y = h == null ? void 0 : h.provider, O = h == null ? void 0 : h.resolved;
      if (!l || x(y, e) || O === void 0 || (e.treeShaking ? M(d.share, n, I) : _(d.share, n)) !== void 0 || l.registered && (i == null ? void 0 : i[l.version]) !== y) return;
      const v = o(O);
      if (e.treeShaking) {
        const R = e.treeShaking.providedExports ?? e.treeShaking.usedExports ?? [];
        ie(d.share, n, R, v), Se(d.share, n, I, v);
      } else T(d.share, n, v, l.from);
    };
    for (const r of Le) {
      const e = C[r];
  ...
  nr = async function(s) {
    ...
    return d.pendingShareLoads && await Promise.all(d.pendingShareLoads), a[s]().then((f) => () => f);
  };
});
export {
  __tla,
